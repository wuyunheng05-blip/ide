...
declare global {
  ...
  interface Window {
    ...
    ai?: { status: () => Promise<AiSettingsStatus>; saveSettings: (settings: { apiKey?: string; doubaoSearchKey?: string; model?: 'deepseek-chat' | 'deepseek-reasoner'; autoWrite?: boolean; confirmBeforeWrite?: boolean; allowWorkspaceCommands?: boolean; clearKey?: boolean; clearDoubaoSearchKey?: boolean }) => Promise<AiSettingsStatus>; chat: (messages: AiChatMessage[], sessionType?: 'project' | 'standalone', sessionKey?: string) => Promise<AiChatResult>; cancel: (sessionKey: string) => Promise<boolean> }
